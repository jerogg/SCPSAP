...
{
    public class ConfiguraAdeudoNegocio
    {
        ConfiguraAdeudoDatos configuraAdeudoDatos = new ConfiguraAdeudoDatos();
        ...
        public List<Adeudo> ObtenerAdeudosConfigurados()
        {
            try
            {
                return configuraAdeudoDatos.ObtenerAdeudosConfigurados();
            }
            catch (Exception ex)
            {
        ...
        public Adeudo ObtenerAdeudoPorId(int id)
        {
            try
            {
                return configuraAdeudoDatos.ObtenerAdeudoPorId(id);
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message);
        ...
        public Adeudo GuardarAdeudo(Adeudo adeudo)
        {
            try
            {
                ...
                return configuraAdeudoDatos.GuardarAdeudo(adeudo);
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message);
        ...
        public bool EliminarAdeudo(int id)
        {
            try
            {
                ...
                return configuraAdeudoDatos.EliminarAdeudo(id);
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message);
        ...
        public bool GuardarPago(Pago pago, List<Tuple<int, decimal>> detalles)
        {
            try
            {
                ...
                return configuraAdeudoDatos.GuardarPago(pago, detalles);
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message);
